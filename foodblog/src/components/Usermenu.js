...
let menu_icon = require("../media/icons/menu.svg");
require("../css/components-styles/Usermenu.css");

class Usermenu extends React.Component {
  drop_down_menu(e) {
    if (document.getElementById("drop_down_menu").className === "disable") {
      document.getElementById("drop_down_menu").className = "active";
    } else {
      document.getElementById("drop_down_menu").className = "disable";
    }
  }
    ...
    return (
      <div id="user_menu_container">
        <div id="user_drop_container">
          ...
          <div id="drop_down_arrow" onClick={this.drop_down_menu}></div>
          <div id="drop_down_menu" className="disable">
            <p>
              <span>login</span> or <span>register</span>
            </p>
          </div>
        </div>
        <div id="burger_menu_container" onClick={this.props.click_menu_bottom}>
          <img src={menu_icon} width="40%" height="40%" alt="" />
        </div>
      </div>
    );
  }
